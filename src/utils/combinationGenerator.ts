...
The 5 ideas that you return must provide the following in a clean list below eachother:
- The idea name
- Combination of interests used
- Potential clients
- Daily tasks
- What i need to charge to generate a decent income
- How i can get my first client and how long it will take to earn money
- Example business or person

Please return only the 5 extensive business idea's, separated by a horizontal line with clean HTML format, bold titles, great readability and no other text. Mention at least 1 example of a look-a-like business or person currently active. don't mention any other sources from the internet.`;
};