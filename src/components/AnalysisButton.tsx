...
const AnalysisButton: React.FC<AnalysisButtonProps> = ({ 
  ...
  return (
    <div className="mt-8 text-center sticky bottom-4 z-50">
      <Button
        onClick={handleClick}
        disabled={disabled || !selectedModel}
        className="bg-gradient-to-r from-primary to-primary-hover hover:from-primary-hover hover:to-primary text-white px-8 py-2 shadow-md hover:shadow-lg transition-all duration-300 w-full md:w-auto min-w-[200px]"
      >
        {isLoading ? (
